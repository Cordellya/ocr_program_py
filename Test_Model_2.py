...
model = tf.keras.models.load_model('saved_model/resnet_new/model_resnet2_100_aug_224_new.h5')
...
plot_images(test_images[:7], IMG_WIDTH, IMG_HEIGHT)
...
#         _,res_test = cv2.threshold(img, 0, 255, cv2.THRESH_BINARY_INV + cv2.THRESH_OTSU)
#         # plt.imshow(res_test)
#         # plt.show()
...
history = np.load('saved_model/resnet_new/history_resnet2_100_aug_224_new.npy', allow_pickle='TRUE').item()
